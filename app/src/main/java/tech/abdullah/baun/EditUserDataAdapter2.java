...
public class EditUserDataAdapter2 extends ArrayAdapter<Data> {
    ...
    private TextView date_pik, time_pik, time_pik2, time_pik3, userName, userAge, amount, note, medcin_in_list;
    ...
    public EditUserDataAdapter2(@NonNull Context context, int resource, List<Data> userInfo, ArrayList<String> medicListName) {
