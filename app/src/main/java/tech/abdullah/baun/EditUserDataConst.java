...
public class EditUserDataConst {
    ...
    public EditUserDataConst(String name, String age, String amountSize, String amountType, String expiryDate, String medicineName, String medicineTime1, String medicineTime2, String medicineTime3, String medicineTimeLocal1, String medicineTimeLocal2, String medicineTimeLocal3, String medicineTimePeriod1, String medicineTimePeriod2, String medicineTimePeriod3, String userNote) {
        this.name = name;
        this.age = age;
    ...
    public EditUserDataConst(String name, String age, String amountSize, String amountType, String expiryDate, String medicineName, String medicineTime1, String medicineTimeLocal1, String medicineTimePeriod1, String userNote) {
        this.name = name;
        this.age = age;
        this.amountSize = amountSize;
        this.amountType = amountType;
    ...
    public EditUserDataConst(String name, String age, String amountSize, String amountType, String expiryDate, String medicineName, String medicineTime1, String medicineTime2, String medicineTimeLocal1, String medicineTimeLocal2, String medicineTimePeriod1, String medicineTimePeriod2, String userNote) {
        this.name = name;
        this.age = age;
        this.amountSize = amountSize;
        this.amountType = amountType;
    ...
    public EditUserDataConst(String name, String age, ArrayList<String> medicNameList, ArrayList<String> medicListName) {
        this.name = name;
        this.age = age;
    ...
    public EditUserDataConst(String medicineName) {
        this.medicineName = medicineName;
    }

    public EditUserDataConst() {
    }
